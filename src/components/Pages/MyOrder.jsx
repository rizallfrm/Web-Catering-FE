...
const MyOrders = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case 'pending':
        return <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded">Menunggu</span>;
      case 'processing':
        return <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded">Diproses</span>;
      case 'completed':
        return <span className="px-2 py-1 bg-green-100 text-green-800 rounded">Selesai</span>;
      case 'cancelled':
        return <span className="px-2 py-1 bg-red-100 text-red-800 rounded">Dibatalkan</span>;
      default:
        return <span className="px-2 py-1 bg-gray-100 text-gray-800 rounded">{status || 'Unknown'}</span>;
    }
  };
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {isLoading ? (
        ...
        <div className="bg-gray-50 rounded-lg p-8 text-center">
          <h3 className="text-lg font-medium text-gray-700 mb-2">Belum ada pesanan</h3>
          ...
          {filteredOrders.map((order) => (
            <div key={order.id} className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="border-t border-b py-4 my-4">
                <p className="font-medium">Total: Rp {order.total_price ? order.total_price.toLocaleString() : '0'}</p>
              ...
              <div className="bg-gray-50 p-4 rounded">
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">
                    Rp {selectedOrder.total_price ? selectedOrder.total_price.toLocaleString() : '0'}
                  </span>
                </div>
              </div>
            </div>
