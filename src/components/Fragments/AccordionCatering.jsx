...
import { ChevronDown, ChevronUp, Package, MapPin, Award, Utensils, Clock, DollarSign } from 'lucide-react';

const AccordionItem = ({ title, icon: Icon, children, isOpen, onClick, animationDelay }) => {
    ...
    >
      ...
      >
        <div className="flex items-center space-x-4">
          {Icon && (
            <div className={`p-2.5 rounded-full ${
              isOpen ? 'bg-amber-500 text-white' : 'bg-amber-100 text-amber-600'
        ...
        <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
          isOpen ? 'bg-amber-500 text-white rotate-180' : 'bg-gray-100 text-gray-500'
        }`}>
        ...
        <div>
              ...
              <div className="grid md:grid-cols-3 gap-5">
                {[
                  ...
                  >
                    ...
                    <h4 className="font-semibold text-amber-800 text-lg mb-2">{item.title}</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-600">
                      Kami juga menyediakan menu khusus sesuai permintaan. Silakan hubungi kami untuk konsultasi menu.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-5">
              <div className="bg-amber-50 p-4 rounded-lg border border-amber-100 mb-6">
                ...
                <p className="text-gray-600 mb-3">
                  Kami melayani pengantaran ke berbagai wilayah di Jakarta dan sekitarnya:
                </p>
              </div>
              
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                  <h5 className="font-medium text-gray-700 mb-3 pb-2 border-b border-gray-100">Kota:</h5>
                  <ul className="space-y-2">
                    {["Jakarta Selatan", "Jakarta Timur", "Jakarta Barat", "Depok"].map((city, idx) => (
                ...
                <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                  <h5 className="font-medium text-gray-700 mb-3 pb-2 border-b border-gray-100">Kecamatan Utama:</h5>
                  <ul className="space-y-2">
                    {["Pancoran", "Kebayoran Baru", "Pondok Indah", "Cilandak"].map((district, idx) => (
                      <li key={idx} className="flex items-center text-gray-600">
                        <span className="w-2 h-2 bg-amber-500 rounded-full mr-2"></span>
                        {district}
                      </li>
              ...
              <div className="mt-6 bg-gray-50 p-4 rounded-lg border border-gray-100 flex items-center">
                ...
                <div>
                  <p className="text-gray-600">
                    <span className="font-medium">Pengantaran:</span> 08.00 - 20.00 WIB (Setiap Hari)
                  </p>
          ...
          >
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-amber-500 to-amber-600 text-white p-6 rounded-xl shadow-md mt-8">
                <div className="flex flex-col md:flex-row items-center justify-between">
                  <div className="mb-4 md:mb-0">
                    <h4 className="font-bold text-xl mb-2">Dapatkan Penawaran Khusus</h4>
                    <p>Hubungi kami untuk konsultasi menu dan penawaran terbaik</p>
                  </div>
                  <button className="px-6 py-3 bg-white text-amber-600 rounded-full font-medium hover:bg-gray-100 transition-all duration-300 shadow-md transform hover:scale-105">
                    Hubungi Sekarang
                  </button>
                </div>
              </div>
