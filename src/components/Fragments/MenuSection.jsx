...
import menu1 from "../../../public/abg.jpg";
import menu2 from "../../../public/herobg3.jpg";
import menu3 from "../../../public/snackbox.jpg";
  ...
  const menuItems = [
    {
      id: 1,
      image: menu1,
      title: "ABG Ayam Bakar Gluntungan",
      description:
        "1 ekor ayam bakar gluntungan pedas manis + sambal + lalapan",
      price: 60000,
      category: "harian",
      featured: true,
      min_order: 1,
    },
    {
      ...
      description: "Nasi putih + ayam bakar laos + sayur + air mineral",
      price: 30000,
      category: "prasmanan",
      featured: true,
      min_order: 15,
    },
    {
      id: 3,
      image: menu3,
      title: "Paket Snack Box Suka Suka",
      description:
        "Aneka kue dan minuman dalam kotak eksklusif dengan presentasi mewah",
      price: 10000,
      category: "acara",
      featured: true,
      min_order: 10,
    ...
    return (
      ...
      >
        ...
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-6 text-sm line-clamp-2">
            <span className="font-bold pr-2">Min order:</span>
            {item.min_order}
          </p>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Nikmati berbagai hidangan premium kami yang disiapkan dengan
            bahan-bahan terbaik dan resep tradisional yang disempurnakan dengan
            sentuhan modern.
          </p>
        </div>
